...
/* Check the following lines: 80-81, 83-84, 86-87, 124, 136, 146, 157 */
...
INSERT INTO SAILW0572V.VB_PEDW_EPS_2015ON_PRE
		...
		FROM SAIL0572V.PEDW_EPISODE_20210801 ep
			LEFT JOIN SAIL0572V.PEDW_SPELL_20210801 sp
				ON ep.PROV_UNIT_CD||ep.SPELL_NUM_PE = sp.PROV_UNIT_CD||sp.SPELL_NUM_PE --link PEDW EPI and SPELL on prov unit cd and spell num--
			LEFT JOIN (SELECT * FROM SAILUKHDV.ICD10_CODES_AND_TITLES_AND_METADATA_20210803
				WHERE SAILUKHDV.ICD10_CODES_AND_TITLES_AND_METADATA_20210803.ICD_VERSION = 'ICD10 5th Edition') AS icd
					ON ep.DIAG_CD_1234 = icd.ALT_CODE
			LEFT JOIN (SELECT * FROM SAILUKHDV.OPCS4_CODES_AND_TITLES_20210803
				WHERE SAILUKHDV.OPCS4_CODES_AND_TITLES_20210803.OPCS_VERSION = '4.9') AS opcs
...
DELETE FROM SAILW0572V.VB_PEDW_EPS_2015ON_ALF_SICD AS sicd
		WHERE sicd.CATEGORY_1_DESCRIPTION LIKE '%Pregnancy with abortive outcome%'
			OR sicd.CATEGORY_1_DESCRIPTION LIKE '%Other diseases caused by chlamydiae%';
	
INSERT INTO SAILW0572V.VB_PEDW_EPS_2015ON_ALF_SICD_OPCS
	(SELECT SICD.* FROM SAILW0572V.VB_PEDW_EPS_2015ON_ALF_SICD AS SICD
	LEFT JOIN SAILW0572V.VB_SENSITIVE_OPCS_CODES AS opcs
		ON SICD.OPER_CD = opcs.CODE
	WHERE opcs.CODE IS NULL);
...
INSERT INTO SAILW0572V.VB_PEDW_EPS_2015ON
	...
	FROM SAILW0572V.VB_PEDW_EPS_2015ON_ALF_SICD_OPCS_HB AS eps
		LEFT JOIN SAIL0572V.ADDE_DEATHS_20210728 AS dd
...
INSERT INTO SAILW0572V.VB_PEDW_FIRST_REPORT_INSTANCE
	(SELECT eps.PROV_UNIT_CD||eps.SPELL_NUM_PE||eps.EPI_NUM AS EPI_ID,
			eps.DIAG_CD_1234,
			eps.AVAIL_FROM_DT
		FROM SAIL0572V.PEDW_EPISODE_20210801 AS eps
